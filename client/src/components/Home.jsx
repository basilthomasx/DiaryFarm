...
function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50">
      <div className="bg-[url('/api/placeholder/1920/1080')] bg-fixed bg-cover bg-center bg-opacity-10">
        <Header/>
        {/* Hero section */}
        <div className="w-full bg-gradient-to-b from-green-50/90 to-blue-50/90 backdrop-blur-sm pt-28">
          <div className="max-w-4xl mx-auto py-16 px-4 text-center">
            <h2 className="text-4xl font-bold text-green-800 mb-6">Welcome to FreshFarm</h2>
        ...
        {/* Service cards */}
        <main className="mt-32 p-8 space-y-24 bg-gradient-to-t from-white/80 to-transparent">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            {/* Service Card 1 */}
            <div className="flex flex-col items-center space-y-4 p-6 hover:shadow-xl transition-all duration-300 rounded-xl bg-white/90 backdrop-blur-sm border border-green-100">
              <div className="p-4 bg-green-100/80 rounded-full">
                <Milk size={32} className="text-green-700" />
              </div>
              <img
          ...
          <div className="flex flex-col items-center space-y-4 p-6 hover:shadow-xl transition-all duration-300 rounded-xl bg-white">
          ...
          <div className="flex flex-col items-center space-y-4 p-6 hover:shadow-xl transition-all duration-300 rounded-xl bg-white">
            <div className="p-4 bg-blue-50 rounded-full">
              <Syringe size={32} className="text-blue-600" />
            </div>
            <img
          ...
          <div className="max-w-3xl mx-auto py-12">
            <p className="text-gray-700 text-xl text-center leading-relaxed bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-md border border-green-100">
          ...
          {/* Information cards */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            <div className="p-6 bg-gradient-to-br from-green-50/90 to-blue-50/90 backdrop-blur-sm rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-green-100">
          ...
          <div className="max-w-3xl mx-auto p-8 bg-white/90 backdrop-blur-sm rounded-xl shadow-md border border-green-100">
            <h2 className="text-2xl font-bold text-green-800 mb-6">Product Information</h2>
